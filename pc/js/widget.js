...
(function() {
    ...
    var is = {
        ...
        set: function(shape) {
            ...
            cache.isPencil = cache.isEraser = cache.isText = false;
            cache['is' + shape] = true;
        }
    };
...
*/
    ...
    var pencilLineWidth = document.getElementById('line-width-style').value,
        pencilStrokeStyle = '#' + document.getElementById('fill-style').value;
    ...
    var textHandler = {
        ...
        writeText: function(keyPressed, isBackKeyPressed) {
            ...
            if (isBackKeyPressed) {
                ...
                textHandler.fillText(Hangul.assemble(textHandler.text));
                return;
            }
...
//            textHandler.fillText(textHandler.text);
        ...
        appendPoints: function() {
            var options = textHandler.getOptions();
            points[points.length] = ['text', ['"' + Hangul.assemble(textHandler.text) + '"', textHandler.x, textHandler.y], drawHelper.getOptions(options)];
        },
        mousedown: function(e) {
            if (!is.isText) return;
        ...
        showOrHideTextTools: function(show) {
            if (show === 'hide') {
                ...
                fillStyle = 'black';
                textHandler.selectedFontSize = globalFontSize;
            }
    ...
    var data_uris = {
        pencil: icons.pencil || 'data:image/svg+xml;base64,',
        eraser: icons.eraser || 'data:image/svg+xml;base64,',
        text: icons.text || 'data:image/svg+xml;base64,',
        lineWidth: icons.lineWidth || 'data:image/svg+xml;base64,',
        colorsPicker: icons.colorsPicker || 'data:image/svg+xml;base64,',
        fonts: icons.fonts || 'data:image/svg+xml;base64,',
        clear: icons.clear || 'data:image/svg+xml;base64,',
    ...
    (function() {
        ...
        function decoratePencil() {
            ...
            /*var pencilContainer = find('pencil-container'),
                ...
                strokeStyleText = find('line-width-style'),
                pencilColorsList = find("pencil-colors-list"),*/
            var fillStyleText = find('fill-style'),
        ...
        function decorateLineWidth() {
            ...
            var lineWidthContainer = find('line-width-container'),
                lineWidthStyle = find('line-width-style'),
            ...
            addEvent(canvas, 'click', function() {
                ...
                lineWidthStyle.focus();
            });

            addEvent(btnLineWidthDone, 'click', function() {
                lineWidthContainer.style.display = 'none';
                pencilLineWidth = lineWidth = lineWidthStyle.value;
            });
        }
        ...
        function decorateColors() {
            ...
            addEvent(btnColorsDone, 'click', function() {
                ...
                pencilStrokeStyle = fillStyle = fillStyleText.value;
            });
        }
        ...
        // Text size image icon load
        function decorateFonts() {
            var context = getContext('fonts');

            var image = new Image();
            image.onload = function() {
                context.drawImage(image, 4, 4, 32, 32);
            };
            image.src = data_uris.fonts;

            var fontsContainer = find('fonts-container'),
                btnFontsDone = find('fonts-done'),
                h1 = document.getElementsByTagName('h1')[0],
                canvas = context.canvas,
                globalFontSizeSelect = find('fonts-size');

            addEvent(canvas, 'click', function() {
                hideContainers();

                fontsContainer.style.display = 'block';
                fontsContainer.style.top = (canvas.offsetTop + 1) + 'px';
                fontsContainer.style.left = (canvas.offsetLeft + canvas.clientWidth) + 'px';
            });

            addEvent(btnFontsDone, 'click', function() {
                fontsContainer.style.display = 'none';
                textHandler.selectedFontSize = globalFontSize = globalFontSizeSelect.value;
            });
    ...
    function hideContainers() {
        var colorsContainer = find('colors-container'),
            ...
            pencilColorContainer = find('pencil-fill-colors'),
            fontsContainer = find('fonts-container'),
            lineWidthContainer = find('line-width-container');
            /*additionalContainer = find('additional-container'),
    ...
    addEvent(canvas, isTouch ? 'touchstart mousedown' : 'mousedown', function(e) {
        ...
        /*else if (cache.isLine) lineHandler.mousedown(e);
    ...
    // mouse 이동 중단 or 영역의 바깥으로 이동
    addEvent(canvas, isTouch ? 'touchend touchcancel mouseup' : 'mouseup mouseout', function(e) {
    ...
    addEvent(canvas, isTouch ? 'touchmove mousemove' : 'mousemove', function(e) {
        ...
        /*else if (cache.isLine) lineHandler.mousemove(e);
...
//        }
    ...
    function syncPoints(isSyncAll, isInit) {
        if (isSyncAll) {
            lastPointIndex = 0;
        }
        ...
        if (pointsToShare.length || isInit) {
            syncData({
